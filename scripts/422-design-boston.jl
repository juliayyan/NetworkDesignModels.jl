...
# JLD2.@load "data/boston-all-results.jld2" allbudgets alloptions allcolumns allruntimes
# push!(allbudgets, budget)
# push!(alloptions, options)
# push!(allcolumns, rmp.linelist)
# push!(allruntimes, runtime)
# JLD2.@save "data/boston/boston-all-results.jld2" allbudgets alloptions allcolumns allruntimes
